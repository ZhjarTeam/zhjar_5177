...
<!--   <form method="get" name="formSearch">
    <input type="hidden" value="menu" name="act">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="index.php?act=menu&op=index" class="btns " title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li><?php echo $lang['menu_index_help1'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><a href="index.php?act=menu&op=edit&menu_id=<?php echo $v['id']; ?>"><?php echo $lang['nc_edit'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
      ...
      <tfoot>
        ...
        <tr class="tfoot">
          ...
          <td colspan="16"><!-- <label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_menu').submit();}"><span><?php echo $lang['nc_del'];?></span></a> -->
