...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>视频管理</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=video&op=index"><span><?php echo $lang['nc_manage'];?></span></a></li>
        <li><a href="index.php?act=video&op=add"><span><?php echo $lang['nc_new'];?></span></a></li>
  ...
  <form id="video_form" method="post">
    ...
    <input type="hidden" name="video_id" value="<?php echo $output['video_array']['id'];?>" />
    <input type="hidden" name="ref_url" value="<?php echo getReferer();?>" />
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="video_title">标题:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['video_array']['name'];?>" name="video_title" id="video_title" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2"><label>类型:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['video_array']['ordering'];?>" name="video_ordering" id="video_ordering" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['video_array']['link_url'];?>" name="video_link" id="video_link_url" class="txt"></td>
        </tr>

        <tr>
          <td colspan="2" class="required">图片: （大图：290*240，小图：180*120，比赛：290*160）</td>
        </tr>
        <tr class="noborder">
          <td colspan="3"><input type="file" multiple="multiple" uptype="3" class="fileupload" name="fileupload" /></td>
        </tr>
        <tr>
          <td colspan="2" class="required">图片预览:</td>
        </tr>
        <tr class="noborder">
          <td colspan="2"><ul class="thumbnails thumblists">
        ...
        <tr>
          <td colspan="2" class="required"><label for="video_time">比赛时间:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required">左球队图标:（尺寸：36*36）</td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required">右球队图标:（尺寸：36*36）</td>
        </tr>
        <tr class="noborder">
...
$(document).ready(function(){
    var de_type = <?php echo $output['video_array']['type'];?>;
    $('#video_type').find('option').eq(de_type-1).attr('selected','selected');
...
function insert_editor(file_path){
	KE.appendHtml('video_description', '<img src="'+ file_path + '" alt="'+ file_path + '">');
}
