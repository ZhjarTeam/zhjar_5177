...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>新闻管理</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=news&op=news"><span><?php echo $lang['nc_manage'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="news_form" method="post" name="newsForm">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="news_color" id="news_color" class="txt"></td>
          <td class="vatop tips">如#EA0000</td>
        </tr>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation">SEO关键词:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="keyword" rows="6" class="tarea" id="keyword"></textarea></td>
          <td class="vatop tips">默认为摘要内容</td>
        </tr>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation">SEO摘要:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="news_short_tit" rows="6" class="tarea" id="news_short_tit"></textarea></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td colspan="2" class="vatop rowform"><?php showEditor('news_content');?></td>
        </tr>
         <tr class="noborder">
          <td colspan="2"><label>排序:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="news_ordering" id="news_ordering" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="news_views" id="news_views" class="txt"></td>
          <td class="vatop tips">初始化</td>
        </tr>
         <tr class="noborder">
          <td colspan="2"><label>作者:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="news_author" id="news_author" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
         <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="news_source_url" id="news_source_url" class="txt"></td>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=news&op=pic_upload',
