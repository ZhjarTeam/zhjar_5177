...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>链接管理</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=links&op=index"><span><?php echo $lang['nc_manage'];?></span></a></li>
  ...
  <form id="links_form" method="post">
    ...
    <input type="hidden" name="links_id" value="<?php echo $output['links_array']['id'];?>" />
    <input type="hidden" name="ref_url" value="<?php echo getReferer();?>" />
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="links_title">标题:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['links_array']['title'];?>" name="links_title" id="links_title" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="links_title">链接地址:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['links_array']['link_url'];?>" name="links_link_url" id="links_link_url" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['links_array']['color'];?>" name="links_color" id="links_color" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['links_array']['ordering'];?>" name="links_ordering" id="links_ordering" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="links_desc" rows="6" class="tarea" id="links_desc"><?php echo $output['links_array']['description'];?></textarea></td>
        ...
        <tr class="noborder">
          <td colspan="2"><ul id="thumbnails" class="thumblists">
              ...
              <li id="<?php echo $v['upload_id'];?>" class="picture" >
                ...
                <p><span><a href="javascript:insert_editor('<?php echo $v['upload_path'];?>');"><?php echo $lang['links_add_insert'];?></a></span><span><a href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');"><?php echo $lang['nc_del'];?></a></span></p>
              </li>
              <?php } ?>
              <?php } ?>
            </ul></td>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=links&op=pic_upload&item_id=<?php echo $output['links_array']['id'];?>',
...
function insert_editor(file_path){
	KE.appendHtml('links_description', '<img src="'+ file_path + '" alt="'+ file_path + '">');
}
