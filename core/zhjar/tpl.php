	...
	public static function showpage($page_name='',$layout='',$time=2000){
		...
		self::getInstance();
			...
			if (file_exists($tpl_file)){
				...
				//页头
				$output['html_title'] = $output['html_title']!='' ? $output['html_title'] :C('site_name');
				$output['seo_keywords'] = $output['seo_keywords']!='' ? $output['seo_keywords'] :C('site_name');
				$output['seo_description'] = $output['seo_description']!='' ? $output['seo_description'] :C('site_name');
